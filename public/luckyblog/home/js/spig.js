...
jQuery(document).ready(function ($) {
    $("#spig").mousedown(function (e) {
        if(e.which==3){
        showMessage("秘密通道:<br /><a href=\"http://luckyadmin.luckyhhy.cn/\" title=\"LuckyAdmin\">LuckyAdmin</a>    <a href=\"http://dao.jackhhy.cn/\" title=\"导航\">导航</a>",10000);
}
});
...
jQuery(document).ready(function ($) {
    ...
    $('.blogtitle a').mouseover(function () {
        showMessage('要看看《<span style="color:#0099cc;">' + $(this).text() + '</span>》这篇文章么？');
    });

    $('.nextinfo a').mouseover(function () {
        showMessage('要看看《<span style="color:#0099cc;">' + $(this).text() + '</span>》这篇文章么？');
    });

    $('.otherlink li a').mouseover(function () {
        showMessage('要看看《<span style="color:#0099cc;">' + $(this).text() + '</span>》这篇文章么？');
    });



    $('.diggit a').mouseover(function () {
        showMessage('点个喜欢可以吗?');
    });
    $('.dasbox a').mouseover(function () {
        showMessage('觉得可以请站长喝杯奶茶吧?');
    });

    $('.weibo').mouseover(function () {
        showMessage('分享到新浪微博哟?');
    });

    $('.qq').mouseover(function () {
        showMessage('分享到QQ好友哟?');
    });

    $('.qqzone').mouseover(function () {
        showMessage('分享到QQ空间哟?');
    });



    $('.tencent a').mouseover(function () {
        showMessage('加站长微信哟');
    });

    $('.email a').mouseover(function () {
        showMessage('联系站长邮箱?');
    });

    $('.wxgzh a').mouseover(function () {
        showMessage('关注站长的微信公众号呀?');
    });

    $('.wx').mouseover(function () {
        showMessage('站长微信公众号二维码，扫码关注哟?');
    });
